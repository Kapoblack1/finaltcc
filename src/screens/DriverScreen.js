    ...
    <BottomSheetScrollView contentContainerStyle={styles.contentContainer}>
      ...
      {destination && (
        ...
        onPress={() => navigation.navigate('TripDetailsScreen', {
          ...
          distance,
          price,
          destinationName, // Inclui o nome do destino
        })}
      >
        <Text style={styles.bookTripButtonText}>Marcar Viagem</Text>
      </TouchableOpacity>
            ...
            <GooglePlacesAutocomplete
              ...
              onPress={(data, details = null) => {
                ...
                if (details && details.geometry) {
                  ...
                  setDestinationName(data.description); // Atualiza o estado com o nome do local
                }
              }}
              query={{
...
const styles = StyleSheet.create({
  ...
  bookTripButton: {
    backgroundColor: "#34C759", // Exemplo de cor
    padding: 15,
    borderRadius: 10,
    alignItems: "center",
    marginHorizontal: 20,
