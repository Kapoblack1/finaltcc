...
import { Check, CaretDown, PlusCircle } from "phosphor-react-native";
      ...
      <ScrollView>
        ...
        <View style={styles.checkboxContainer}>
          ...
          <Text style={styles.checkboxLabel}>
            Upload do bilhete de identidade (frontal)
          </Text>
          <PlusCircle size={20} color="#D0D0D0" weight="bold"></PlusCircle>
        </View>
        ...
        <View style={styles.checkboxContainer}>
          ...
          <Text style={styles.checkboxLabel}>
          Upload do bilhete de identidade (traseiro)
          </Text>
          <PlusCircle size={20} color="#D0D0D0" weight="bold"></PlusCircle>
        </View>
...
(frontal)          </Text>
        ...
        <View style={styles.checkboxContainer}>
          ...
          <Text style={styles.checkboxLabel}>
          Upload do carta de condução (traseiro)          </Text>
          <PlusCircle size={20} color="#D0D0D0" weight="bold"></PlusCircle>
        </View>
        ...
        <View style={styles.checkboxContainer}>
          ...
          <TouchableOpacity><PlusCircle size={20} color="#D0D0D0" weight="bold"></PlusCircle></TouchableOpacity>
        </View>
